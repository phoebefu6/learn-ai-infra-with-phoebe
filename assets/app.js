...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-what-ai-infra-is.html", "a2-layer-map.html", "a3-build-buy-rent.html", "a4-cost-model.html", "a5-launches-and-failures.html", "a6-your-roadmap.html"]
        : ["b1-layers-and-personas.html", "b2-storage-formats.html", "b3-catalog-governance.html", "b4-ingestion-orchestration.html", "b5-lakehouse-engine.html", "b6-semantic-bi.html", "b7-compute-mlops.html", "b8-llm-gateway.html", "b9-self-serve.html", "b10-capstone-architecture.html"];
